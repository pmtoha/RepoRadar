...
```
RepoRadar/
├── .env.example           # Example of how to set up tokens
├── .gitignore             # Ignore venv and .env files
├── requirements.txt       # List of dependencies
├── README.md              # Setup instructions and screenshots
├── main.py                # Entry point of the application
├── bot/
│   ├── __init__.py
│   ├── handlers.py        # Command handlers (/start, /search)
│   ├── keyboards.py       # Inline buttons and layouts
│   └── messages.py        # Text formatting strings
├── github/
│   ├── __init__.py
│   └── client.py          # Logic to call GitHub API
└── database/
    ├── __init__.py
...
- `BOT_TOKEN`: Talk to [@BotFather](https://t.me/botfather) on Telegram and create a new bot.
